...
<html lang="{{ LANGUAGE_CODE|default:"en-us" }}">
    ...
    <body>
        ...
        <ul id="user-menu" class="dropdown-content">
            {% block user_menu %}
            <li><a href="/admin/auth/user/1/">{% trans 'Profile' %}</a></li>
        ...
        <header>
            <nav id="header" class="nav-top">
                <div class="nav-wrapper">
                    ...
                    <ul class="right">
                        {% if user.is_authenticated %}
                        <li><a class="dropdown-button" href="#!" data-activates="user-menu"><img class="avatar left mdi-img circle" src="https://scontent-mia1-1.xx.fbcdn.net/hphotos-xap1/v/t1.0-9/10410335_10205829253124742_2272017007544613417_n.jpg?oh=d8f18336a22a2f73ee63fa86cddb4981&oe=56043BA5">{{ user.get_full_name|default:user.username }}<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
                        {% endif %}
                    </ul>
                </div>
